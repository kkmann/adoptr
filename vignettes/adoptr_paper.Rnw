...
\begin{figure}
<<plot1, fig=TRUE, height=2.8125, width=7.5>>=
...
\begin{figure}
<<plot2, fig=TRUE, echo=FALSE, warning=FALSE, height=2.8125, width=7.5>>=
x1    <- seq(0, 3, by = .01)
theta <- seq(0, .4, by = .01)
...
\begin{figure}
<<plot3, fig=TRUE, echo=FALSE, warning=FALSE, height=2.8125, width=7.5>>=
   x1 <- seq(0, 3, by = .01)
...
\begin{figure}
<<plot4, fig=TRUE, echo=FALSE, warning=FALSE, height=2.8125, width=7.5>>=
...
The first two authors contributed equally to the completion of this manuscript.
