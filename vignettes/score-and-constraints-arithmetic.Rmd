...
Consider the following group-sequenital example design
```{r define-design}
...
power.
The resulting socre is of class `IntegralScore`, a specific subclass of 
...
stop early for futility under no differenceas
