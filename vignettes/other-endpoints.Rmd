...
- $X_i^C$ will denotes the observation of recruit $i$ in the control arm
...
It is a well-known that this test statistic is asymptotically normal, and we will
...
Thus, when conducting the interim analysis in an adaptive design, some patients
may not have had an event yet, even though those could lead to an opposite decision
than the patients available at interim do. This issue is known as "over-running".
Additionally, these recruits that have not had an event till the interim analysis
