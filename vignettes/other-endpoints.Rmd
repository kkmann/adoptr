...
Either the final analysis is conducted, $i$ had an event or they was censored.
...
log-rank statistic,
and in practice, the `surival::coxph` method can handle datasets of the aforementioned structure.
