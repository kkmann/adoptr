...
The recruits that have not had an event until the interim analysis
provide information for both stages: in the first stage, we know that these
subjects survived, and in the second stage, they might die or they might survive
until the end of the trial. Therefore, the construction of stage-wise test
statistics which use all available information, but do not contain the
same inform

`adoptr`


Thus, the test statistics $L_{1}$ from the interim analysis
