...
```{r}
sim_null_1 <- simulate(optimal_design, 10000, dist, .0, seed = 1)
sim_alt_1  <- simulate(optimal_design, 10000, dist, .4, seed = 1)
```
...
```{r}
sim_null_2 <- simulate(optimal_design, 10000, dist, .0, seed = 2)
sim_alt_2  <- simulate(optimal_design, 10000, dist, .4, seed = 2)
```
...
```{r}
sim_null_3 <- simulate(optimal_design_3, 10000, dist, .0, seed = 3)
sim_alt_3  <- simulate(optimal_design_3, 10000, dist, .4, seed = 3)
```
...
```{r}
sim_null_4 <- simulate(optimal_design_4, 10000, dist, .0, seed = 4)
sim_alt_4  <- simulate(optimal_design_4, 10000, dist, .4, seed = 4)
```
...
```{r}
sim_null_5 <- simulate(optimal_design_5, 10000, dist, .0, seed = 5)
```
...
Simulation is only possible for type one error rate.
```{r}
sim_null_6 <- simulate(optimal_design_6, 10000, dist, .0, seed = 6)
```
...
Simulation is only possible for type one error rate.
```{r}
sim_null_7 <- simulate(optimal_design_7, 10000, dist, .0, seed = 7)
```
...
Simulation is only possible for type one error rate.
```{r}
sim_null_8 <- simulate(optimal_design_8, 10000, dist, .0, seed = 8)
```
